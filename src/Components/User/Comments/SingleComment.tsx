...
const SingleComment = ({isLoading,comment,index} :SingleCommentPropsInterface) => {
  ...
  return (
    <div>
       <div key={index} className="w-full border-black border-2 rounded-xl flex items-start mb-4 p-3">
           <div className="w-12 h-12 rounded-full overflow-hidden mr-3">
            ...
            <div className="flex-1">
                ...
                <div className="text-sm mt-1 flex flex-col">
                    ...
                    <span>{getTimeDifference(comment.createdAt.toString())}</span>
                </div>
            </div>
