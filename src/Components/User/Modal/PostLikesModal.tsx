...
const PostLikesModal = ({ likesData, closeModal }: PostLikesModalInterface) => {
  ...
  return (
    <Modal 
      ...
      className="relative  bg-white p-5 max-w-lg w-11/12 max-h-[90vh] overflow-hidden rounded-lg shadow-lg"
    ...
    >
      ...
      <div className=" no-scrollbar text-center overflow-y-auto max-h-[80vh]">
        <h1 className="mb-5 text-2xl font-semibold text-gray-800">Likes</h1>
