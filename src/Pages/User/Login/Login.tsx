          ...
          <div className="w-full px-8 md:px-32 lg:px-24">
            <form className="bg-white rounded-md shadow-2xl p-5" onSubmit={handleSubmit}>
              ...
              <div className="flex items-center border-2 mb-8 py-2 px-3 rounded-2xl">
                ...
                <input id="email" className="pl-2 w-full outline-none border-none" value={loginDetails.email} onChange={handleChange} type="email" name="email" placeholder="Email Address" />
              </div>
